export default {
  ...
  'content.product.order-fields': 'Custom Orders',
  'content.product.order-fields.open': 'Enable Custom Orders',
  'content.product.order-fields.open.no': 'Disable',
  'content.product.order-fields.open.yes': 'Enable',
  'content.product.order-fields.manage': 'Custom Order Field Management',
  'content.product.batch-price': 'Set batch price',
  'content.product.batch-stock': 'Set batch stock',
  'content.product.sku-fields': 'Set SKU fields',
  ...
  'content.product.add': 'Add product',
  'content.media.name': 'Media resource',
  'content.media.video.add': 'Add video',
  'content.media.image.add': 'Add image',
  'content.product.price': 'Pricing',
  'content.product.shipping': 'Shipping',
  'content.product.logistics': 'Shipping',
  'content.product.need-logistics': 'Shipping required',
  'content.product.free-shipping': 'Free shipping',
  'content.product.weight': 'Weight',
  'content.product.option.type': 'Attribute type',
  'content.product.option.type.single': 'Single attribute',
  'content.product.option.type.multiple': 'Multiple attributes',
  'content.product.option.type.addon': 'Add multiple attributes',
  'content.product.option.type.add': 'Add an attribute',
  'content.product.option.type.name': 'Attribute name',
  'content.product.option.type.placeholder': 'Please enter the attribute name',
  'content.product.option.value': 'Option value',
  'content.product.option.value.placeholder': 'Please enter the option value',
  'content.product.option.value.name': 'Name',
  'content.product.option.value.price': 'Price',
  'content.product.option.value.price.placeholder': 'Please enter the price',
  'content.product.option.value.add': 'Add an option',
  'content.product.option.value.is_default': 'Is default',
  'content.product.option.skus': 'Multiple attribute specifications',
  'content.product.option.skus.extra': 'Options',
  'content.product.option.sku.name': 'Variations',
  'content.product.option.sku.image': 'Image',
  'content.product.option.sku.price': 'Price',
  'content.product.option.sku.stock': 'Availability',
  'content.product.stock': 'Stock',
  'content.product.oversold': 'Oversold',
  'content.product.allow-oversold': 'Continue selling after stockout',
  'content.product.wholesale': 'Wholesale',
  'content.product.is-wholesale': 'Support wholesale',
  'content.product.wholesale.range': 'Quantity range',
  'content.product.wholesale.discount': 'Discount',
  'content.product.wholesale.discount.tips': 'Default 100, means no discount',
  'content.product.wholesale.add': 'Add',
  'content.product.user-limit': 'User Limit',
  'content.product.user-limit.description': '0 means no limit',
  'content.product.user-limit.max-quantity': 'Maximum Purchase Quantity',
  'content.product.user-limit.min-quantity': 'Minimum Purchase Quantity',
  'content.product.user-limit.step-quantity': 'Purchase Quantity Step',
  'content.product.user-limit.step-quantity.placeholder':
    '比如步长是2，最小购买数量是2，用户就只能购买2、4、6、8这样的数量',
  'content.thumb.name': 'Thumbnail',
  'content.origin_price.name': 'Original price',
  'content.origin_price.description':
    'Usually displayed as a strike-through price',
  'content.cost_price.name': 'Cost price',
  'content.profit.name': 'Profit',
  'content.profit_percent.name': 'Profit percentage',
};
